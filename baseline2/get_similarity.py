...
# glove_model = gensim.models.Word2Vec.load_word2vec_format('glove_model.txt')
glove_model = word2vec.KeyedVectors.load_word2vec_format('glove_model.txt')

print(glove_model.similarity(['Man'], ['Woman']))
